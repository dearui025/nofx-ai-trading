...
export default function AILearning({ traderId }: AILearningProps) {
  ...
  // 获取最新的AI决策记录
  const { data: latestDecisions, error: decisionsError } = useSWR<DecisionRecord[]>(
    traderId ? `latest-decisions-${traderId}` : 'latest-decisions',
  ...
  // 检查是否有完成的交易数据
  const hasCompletedTrades = performance && performance.total_trades > 0;
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="rounded-2xl p-5 relative overflow-hidden" style={{
            background: 'linear-gradient(135deg, rgba(16, 185, 129, 0.15) 0%, rgba(30, 35, 41, 0.8) 100%)',
            ...
            <div className="relative">
              <div className="flex items-center gap-2 mb-3">
                ...
                <div className="text-sm font-semibold" style={{ color: '#6EE7B7' }}>AI运行状态</div>
              </div>
              <div className="text-lg font-bold mb-1" style={{ color: '#10B981' }}>
                正常运行
              </div>
          ...
          <div className="rounded-2xl p-5 relative overflow-hidden" style={{
            background: 'linear-gradient(135deg, rgba(240, 185, 11, 0.15) 0%, rgba(30, 35, 41, 0.8) 100%)',
            ...
            <div className="relative">
              <div className="flex items-center gap-2 mb-3">
                <span className="text-2xl">📊</span>
                <div className="text-sm font-semibold" style={{ color: '#FCD34D' }}>市场分析</div>
              </div>
          ...
          <div className="rounded-2xl p-5 relative overflow-hidden" style={{
            background: 'linear-gradient(135deg, rgba(99, 102, 241, 0.15) 0%, rgba(30, 35, 41, 0.8) 100%)',
            ...
            <div className="relative">
              <div className="flex items-center gap-2 mb-3">
                <span className="text-2xl">⚡</span>
                <div className="text-sm font-semibold" style={{ color: '#A5B4FC' }}>决策引擎</div>
              </div>
              <div className="text-lg font-bold mb-1" style={{ color: '#6366F1' }}>
                待机中
              </div>
              <div className="text-xs" style={{ color: '#94A3B8' }}>
                等待交易信号
        ...
        <div className="rounded-2xl p-6" style={{
          background: 'linear-gradient(135deg, rgba(240, 185, 11, 0.1) 0%, rgba(30, 35, 41, 0.8) 100%)',
          ...
          <div className="text-center">
            ...
            <div className="text-sm mb-4" style={{ color: '#848E9C' }}>
              AI正在进行交易决策，完成交易后将显示详细的学习分析数据
            </div>
            ...
            <div className="max-w-md mx-auto">
              ...
              <div className="text-xs mt-2" style={{ color: '#A78BFA' }}>
                正在等待合适的交易机会...
              </div>
            </div>
          </div>
        ...
        <div className="rounded-2xl p-6" style={{
          ...
          <h3 className="text-lg font-bold mb-4 flex items-center gap-2" style={{ color: '#EAECEF' }}>
            <span className="text-2xl">👁️</span>
            当前监控币种
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {['BTCUSDT', 'ETHUSDT', 'SOLUSDT', 'ADAUSDT'].map((symbol, i) => (
              <div key={symbol} className="p-3 rounded-lg text-center" style={{
                background: 'rgba(11, 14, 17, 0.8)',
                border: '1px solid rgba(43, 49, 57, 0.8)'
              }}>
                <div className="font-mono font-bold text-sm mb-1" style={{ color: '#EAECEF' }}>
                  {symbol}
                </div>
                <div className="flex items-center justify-center gap-1">
                  <div className="w-2 h-2 rounded-full bg-green-400 animate-pulse"></div>
                  <span className="text-xs" style={{ color: '#10B981' }}>监控中</span>
                </div>
              </div>
            ))}
          </div>
        ...
        {latestDecisions && latestDecisions.length > 0 && (
          <div className="rounded-2xl p-6" style={{
            ...
            <div className="space-y-4">
              {latestDecisions.slice(0, 3).map((decision, i) => (
                <div key={`${decision.timestamp}-${i}`} className="p-4 rounded-lg" style={{
                  background: '#0B0E11',
                  border: '1px solid #2B3139'
                }}>
                  <div className="flex items-center justify-between mb-2">
                    <div className="text-sm font-semibold" style={{ color: '#EAECEF' }}>
                      周期 #{decision.cycle_number}
                    </div>
                        ...
                        <div key={j} className="flex items-center gap-2 text-sm">
                          ...
                          <span className="px-2 py-1 rounded text-xs font-bold" style={{
                            background: action.action.includes('open') 
                              ? 'rgba(96, 165, 250, 0.1)' 
                              : 'rgba(240, 185, 11, 0.1)',
                            color: action.action.includes('open') ? '#60a5fa' : '#F0B90B'
                          }}>
                            {action.action}
                          </span>
        ...
        <div className="rounded-2xl p-6 backdrop-blur-sm" style={{
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold mb-3 text-base" style={{ color: '#FCD34D' }}>AI如何学习交易</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                <div className="flex items-start gap-2">
                  <span style={{ color: '#F0B90B' }}>•</span>
                  <span style={{ color: '#CBD5E1' }}>实时分析市场数据和价格趋势</span>
                </div>
                <div className="flex items-start gap-2">
                  <span style={{ color: '#F0B90B' }}>•</span>
                  <span style={{ color: '#CBD5E1' }}>识别技术指标和交易信号</span>
                </div>
                <div className="flex items-start gap-2">
                  <span style={{ color: '#F0B90B' }}>•</span>
                  <span style={{ color: '#CBD5E1' }}>评估风险并制定交易策略</span>
                </div>
                <div className="flex items-start gap-2">
                  <span style={{ color: '#F0B90B' }}>•</span>
                  <span style={{ color: '#CBD5E1' }}>从每次交易结果中学习优化</span>
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="space-y-8">
      ...
      {/* 亏损订单分析区域 - 只显示亏损订单 */}
       <div className="rounded-2xl p-6 backdrop-blur-sm" style={{
         background: 'linear-gradient(135deg, rgba(248, 113, 113, 0.15) 0%, rgba(239, 68, 68, 0.1) 50%, rgba(30, 35, 41, 0.8) 100%)',
         border: '1px solid rgba(248, 113, 113, 0.3)',
         ...
         <div className="flex items-center gap-4 mb-6">
           ...
           <div>
             <h3 className="text-2xl font-bold mb-1" style={{ color: '#FEE2E2' }}>亏损订单分析</h3>
         ...
         <div className="space-y-6">
           ...
           <div className="rounded-xl p-5 transition-all" style={{
             ...
             <div className="flex items-center justify-between mb-4">
               <div className="flex items-center gap-3">
                 ...
                 <div>
                   <div className="text-sm font-semibold" style={{ color: '#FEE2E2' }}>DOTUSDT 亏损订单</div>
                   <div className="text-xs" style={{ color: '#FCA5A5' }}>开仓时间: 11/01 21:38:42 | 持仓: 2分钟</div>
                 </div>
               </div>
               <div className="text-right">
                 <div className="text-lg font-bold" style={{ color: '#F87171' }}>-1.19%</div>
                 <div className="text-xs" style={{ color: '#FCA5A5' }}>浮亏约 -35 USDT</div>
               </div>
             </div>

             {/* 开仓决策分析 */}
             <div className="mb-4">
               <div className="text-xs font-semibold mb-2 uppercase tracking-wider" style={{ color: '#FCA5A5' }}>
                 开仓决策详情
               </div>
               <div className="grid grid-cols-2 gap-4 text-sm">
                 <div>
                   <span style={{ color: '#94A3B8' }}>开仓价格:</span>
                   <span className="ml-2 font-mono" style={{ color: '#FEE2E2' }}>$2.952</span>
                 </div>
                 <div>
                   <span style={{ color: '#94A3B8' }}>当前价格:</span>
                   <span className="ml-2 font-mono" style={{ color: '#F87171' }}>$2.927</span>
                 </div>
                 <div>
                   <span style={{ color: '#94A3B8' }}>杠杆倍数:</span>
                   <span className="ml-2 font-mono" style={{ color: '#FEE2E2' }}>5x</span>
                 </div>
                 <div>
                   <span style={{ color: '#94A3B8' }}>仓位大小:</span>
                   <span className="ml-2 font-mono" style={{ color: '#FEE2E2' }}>$3,977</span>
                 </div>
                 <div>
                   <span style={{ color: '#94A3B8' }}>止损价格:</span>
                   <span className="ml-2 font-mono" style={{ color: '#F87171' }}>$2.88</span>
                 </div>
                 <div>
                   <span style={{ color: '#94A3B8' }}>止盈价格:</span>
                   <span className="ml-2 font-mono" style={{ color: '#10B981' }}>$3.08</span>
                 </div>
               </div>
             </div>
             ...
             <div className="mb-4">
               ...
               <div className="grid grid-cols-3 gap-4 text-sm">
                 <div className="text-center p-3 rounded-lg" style={{ background: 'rgba(248, 113, 113, 0.1)' }}>
                   <div style={{ color: '#94A3B8' }}>RSI7</div>
                   <div className="font-mono font-bold" style={{ color: '#FCA5A5' }}>66.765</div>
                   <div className="text-xs" style={{ color: '#94A3B8' }}>中性偏强</div>
                 </div>
                 <div className="text-center p-3 rounded-lg" style={{ background: 'rgba(248, 113, 113, 0.1)' }}>
                   <div style={{ color: '#94A3B8' }}>EMA突破</div>
                   <div className="font-mono font-bold" style={{ color: '#FCA5A5' }}>2.952 &gt; 2.944</div>
                   <div className="text-xs" style={{ color: '#94A3B8' }}>微弱突破</div>
                 </div>
                 <div className="text-center p-3 rounded-lg" style={{ background: 'rgba(248, 113, 113, 0.1)' }}>
                   <div style={{ color: '#94A3B8' }}>信号强度</div>
                   <div className="font-mono font-bold" style={{ color: '#F59E0B' }}>70.7分</div>
                   <div className="text-xs" style={{ color: '#94A3B8' }}>未达标准</div>
                 </div>
               </div>
             </div>
             ...
             <div className="rounded-lg p-4" style={{
               ...
               <div className="text-xs font-semibold mb-3 uppercase tracking-wider flex items-center gap-2" style={{ color: '#F87171' }}>
                 🔍 亏损原因分析
               </div>
               <div className="space-y-3 text-sm" style={{ color: '#FEE2E2' }}>
                 <div className="flex items-start gap-2">
                   <span className="text-red-400 mt-1">❌</span>
                   <div>
                     <strong>信号强度不足:</strong> 70.7分未达到75分开仓标准，在夏普比率为负的情况下应更加谨慎
                   </div>
                 </div>
                 <div className="flex items-start gap-2">
                   <span className="text-red-400 mt-1">❌</span>
                   <div>
                     <strong>技术突破微弱:</strong> 价格仅微弱突破EMA20 (2.952 vs 2.944)，缺乏强势确认
                   </div>
                 </div>
                 <div className="flex items-start gap-2">
                   <span className="text-red-400 mt-1">❌</span>
                   <div>
                     <strong>市场环境不利:</strong> 低波动率市场(45%置信度)，缺乏明确趋势方向
                   </div>
                 </div>
                 <div className="flex items-start gap-2">
                   <span className="text-red-400 mt-1">❌</span>
                   <div>
                     <strong>风险控制失效:</strong> 夏普比率-0.01时仍开新仓，违背了保守策略原则
                   </div>
                 </div>
               </div>
             </div>
           ...
           <div className="rounded-xl p-5" style={{
             ...
             <div className="text-xs font-semibold mb-3 uppercase tracking-wider flex items-center gap-2" style={{ color: '#10B981' }}>
               💡 改进建议
             </div>
             <div className="space-y-3 text-sm" style={{ color: '#D1FAE5' }}>
               <div className="flex items-start gap-2">
                 <span className="text-green-400 mt-1">✅</span>
                 <div>
                   <strong>提高信号阈值:</strong> 在夏普比率为负时，将开仓信号强度要求从75分提升至80分
                 </div>
               </div>
               <div className="flex items-start gap-2">
                 <span className="text-green-400 mt-1">✅</span>
                 <div>
                   <strong>强化技术确认:</strong> 要求价格突破EMA20至少1%以上，并配合成交量确认
                 </div>
               </div>
               <div className="flex items-start gap-2">
                 <span className="text-green-400 mt-1">✅</span>
                 <div>
                   <strong>优化仓位管理:</strong> 已实施负夏普比率时仓位减半策略(16%→8%)，继续执行
                 </div>
               </div>
               <div className="flex items-start gap-2">
                 <span className="text-green-400 mt-1">✅</span>
                 <div>
                   <strong>缩短观察期:</strong> 在不确定市场中将强制观察期从15分钟缩短至10分钟
                 </div>
               </div>
               <div className="flex items-start gap-2">
                 <span className="text-green-400 mt-1">✅</span>
                 <div>
                   <strong>动态止损:</strong> 实施更紧密的止损策略，在微弱突破时设置更保守的止损位
                 </div>
               </div>
             </div>
           </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
             <div className="text-center p-4 rounded-xl" style={{
               ...
               <div className="text-lg font-bold" style={{ color: '#FCA5A5' }}>
                 1
               </div>
             </div>
