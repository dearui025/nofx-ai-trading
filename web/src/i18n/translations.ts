...
export const translations = {
  en: {
    ...
    waitingForTradesDesc: 'AI is analyzing market conditions. First trades will appear soon.',
    latestDecisions: 'Latest AI Decisions',
  },
  zh: {
    // Header
    appTitle: 'AI交易竞赛',
    ...
    waitingForTradesDesc: 'AI正在分析市场状况，首批交易即将开始。',
    latestDecisions: '最新AI决策',
  }
};
